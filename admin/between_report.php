  ...
  <div id="main">
    ...
    <div class="wrapper">
          ...
          <div class="container">
            <div class="row">
              <div class="col s12 m12 l12">
                <h5 class="breadcrumbs-title">Between Dates Report</h5>
              </div>
            </div>
          </div>
        </div>
      ...
      <!-- <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate"> -->
          <form method="post" name="bwdatesreport" action="dates_report.php">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-12">
                                                <input type="date" class="form-control" id="todate" name="todate" value="" max="<?php echo date("Y-m-d");?>" required='true'>
                                            </div>
                                        </div>
