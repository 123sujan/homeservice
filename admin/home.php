		  ...
		  <!-- <form class="formValidate" id="formValidate" method="post" action="routers/menu-router.php" novalidate="novalidate"> -->
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Order Services</h4>
              </div>
              <div>
				<table id="data-table-admin" class="responsive-table display" cellspacing="0">
                    <thead>
                      <tr>
                        <th>Serice Category</th>
                        <th>SubSerivice Name</th>
                        <th>Discription</th>
                        <th>Cost</th>
                        <th>Availability</th>
                        <th>Modify</th>
...
<!--
                ...
                <tr><td><div class="input-field col s12"><label for="2_name">Name</label><input value="Item 2" id="2_name" name="2_name" type="text" data-error=".errorTxt2"><div class="errorTxt2"></div></td><td><div class="input-field col s12 "><label for="2_price">Price</label><input value="45" id="2_price" name="2_price" type="text" data-error=".errorTxt2"><div class="errorTxt2"></div></td><td><select name="2_hide">
                    ...
                    <?php
                    	include("../config.php");
                    	$sql = "select ss.kathe,ssid,ss.name as ss_name,s.name as s_name,cost,ss.available from subservice ss,service s where s.sid=ss.sid order by s.sid;";
                    	...
                    	while($row = $query->fetch_assoc()) {
                    		...
                    		echo '<tr><form class="formValidate" class="form-group" id="formValidate" method="POST" action="modify.php" novalidate="novalidate">
                    			<input type="hidden" name="ssid" value="'.$row['ssid'].'"></input>
                    			<input type="hidden" name="DEV2" value="0"></input>
                    			
                    			
                    			<td><div class="input-field col s12"><label for="1_name">Service Name</label><input value="'.$row['s_name'].'" id="1_name" name="s_name" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
                    			<td><div class="input-field col s12"><label for="1_name">Sub Service</label><input value="'.$row['ss_name'].'" id="1_name" name="ss_name" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
                    			<td><div class="input-field col s12 "><label for="1_price">Discription</label><input value="'.$row['kathe'].'" id="1_price" name="kathe" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
                    			<td><div class="input-field col s12 "><label for="1_price">Price</label><input value="'.$row['cost'].'" id="1_price" name="cost" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
                    			<td><div class="input-field col s12"><label for="1_name">Availiability</label><input value="'.$avail.'" id="1_name" name="avail" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
                    			
                    			<td><div class="input-field col s12"><button class="btn cyan waves-effect waves-light right" type="submit" name="modify">Modify
		 ...
		 <!--  <form class="formValidate" id="formValidate1" method="post" action="modify.php" novalidate="novalidate">
            <div class="row">
              <div class="col s12 m4 l3">
                <h4 class="header">Add Subservice</h4>
              </div>
              <div>
<table>
                    <thead>
                      <tr>
                        ...
                        <th data-field="name">Subservice Name</th>
                        <th data-field="name">Discription</th>
                        <th data-field="name">Item Price/Piece</th>
                        <th data-field="name">Availiability</th>
                      </tr>
                    </thead>

                    <tbody>
				<?php		
          echo '<td><div class="input-field col s12 "><label for="price" class="">Service</label>';
          echo '<input id="price" name="service" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';

					echo '<td><div class="input-field col s12 "><label for="price" class="">Sub Service</label>';
					echo '<input id="price" name="subservice" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';
          echo '<td><div class="input-field col s12 "><label for="price" class="">Discription</label>';
          echo '<input id="price" name="kathe" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';
          echo '<td><div class="input-field col s12 "><label for="price" class="">Price</label>';
          echo '<input id="price" name="aprice" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';                   
          echo '<td><div class="input-field col s12 "><label for="price" class="">Availiability</label>';
          echo '<input id="price" name="avail" type="text" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';                   
