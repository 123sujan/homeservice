      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Services</a>
                        ...
                        <li class="bold active"><a class=" waves-effect waves-cyan active"><i class="mdi-editor-insert-invitation"></i> Orders</a>
...
<div id="work-collections" class="seaction">
					...
					$sql = mysqli_query($db, "SELECT * FROM trans;");
          $sql8 = mysqli_query($db, "SELECT count(*) FROM trans;");
                        $row8 = mysqli_fetch_array($sql8);
                         echo '<p><strong>Total Number of transation: </strong>'.$row8['count(*)'].'</p>';
					echo '<div class="row">
                <div>
            ...
            $status1 = $row['completed'];
						echo '<li class="collection-item avatar">
                              ...
                              <span class="collection-header">Req Id. '.$row['transid'].'</span>
