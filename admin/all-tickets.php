      ...
      <aside id="left-sidebar-nav">
        <ul id="slide-out" class="side-nav fixed leftside-navigation">
            ...
            <li class="bold"><a href="index.php" class="waves-effect waves-cyan"><i class="mdi-editor-border-color"></i> Services</a>
                        ...
                        <li class="bold  active"><a class=" waves-effect waves-cyan active"><i class="mdi-action-question-answer"></i> CUSTOMER SUPPORT</a>
                    ...
                    <?php
                    	...
                    	while($row = $query->fetch_assoc()) {
                    		echo '<tr><form class="formValidate" class="form-group" id="formValidate" method="POST" action="modify.php" novalidate="novalidate">
                    			...
                    			<td><div class="input-field col s12"><label for="1_name">Username</label><input value="'.$row['qname'].'" id="1_name" name="uname" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
                    			<td><div class="input-field col s12"><label for="1_name">Email</label><input value="'.$row['qemail'].'" id="email" name="email" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
                    			<td><div class="input-field col s12"><label for="1_name">Subject</label><input value="'.$row['qsubject'].'" id="1_name" name="password" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
                    		
                    			<td><div class="input-field col s12 "><label for="1_price">Message</label><input value="'.$row['qmessage'].'" id="1_price" name="address" type="text" data-error=".errorTxt1"><div class="errorTxt1"></div></td>
